...
CPPFLAGS          += $(CPPFLAGS_QTCORE) $(CPPFLAGS_QTGUI) $(CPPFLAGS_QTWIDGETS) $(CPPFLAGS_QTSVG) $(CPPFLAGS_QTMULTIMEDIA) $(CPPFLAGS_QTMULTIMEDIAWIDGETS) $(CPPFLAGS_XML) $(CPPFLAGS_GLIB) $(CPPFLAGS_PNG) $(CPPFLAGS_JPEG) -Iinclude -Ilibs
ASSIMP_INTERNAL    ?= no
